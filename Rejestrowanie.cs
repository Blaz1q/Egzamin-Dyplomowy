    ...
    public partial class Rejestrowanie : UserControl
    {
        ...
        private void linkLabel3_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            if (this.ParentForm is Form1 mainForm)
            {
                ...
                aktywuj.userlogin = mailtext.Text; // zak³adam, ¿e chcesz pobraæ login z pola mailtext
        ...
        // Tu wklej resztê wygenerowanego przez designer kodu (InitializeComponent itp.)
        // i resztê event handlerów, które ju¿ masz w klasie Rejestrowanie
